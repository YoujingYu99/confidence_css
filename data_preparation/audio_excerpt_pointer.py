...
This script uses information in the csv file Cleaned_Results to generate an audio pointer. Everything before step 3 is done by the author once and for all;
"""
