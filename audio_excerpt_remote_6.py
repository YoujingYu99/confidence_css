...
csv_path = os.path.join(home_dir, "data_sheets", "confidence_dataframe_6.csv")
# Audio data file
fileDir = os.path.join(home_dir, "data")
audio_path = os.path.join(
    fileDir, "Spotify-Podcasts", "podcasts-audio-only-2TB", "podcasts-audio", "6"
)
# audio_path = os.path.join(
#     fileDir, 'Spotify-Podcasts', 'podcasts-audio-only-2TB', 'podcasts-audio', '0'
# )
excerpt_output_path = os.path.join(home_dir, "extracted_audio", "6")
